...
-- Wait for all required modules to exist
repeat wait() until ReplicatedStorage.FPSSystem:FindFirstChild("RemoteEvents") and
                   ReplicatedStorage.FPSSystem.RemoteEvents:FindFirstChild("RemoteEventsManager") and
                   ReplicatedStorage.FPSSystem:FindFirstChild("Modules") and
                   ReplicatedStorage.FPSSystem.Modules:FindFirstChild("WeaponConfig") and
                   ReplicatedStorage.FPSSystem.Modules:FindFirstChild("RaycastSystem") and
                   ReplicatedStorage.FPSSystem.Modules:FindFirstChild("AttachmentManager") and
                   ReplicatedStorage.FPSSystem.Modules:FindFirstChild("ViewmodelSystem")
